...
const KOOPA_FULL_COLLISION_SHAPE = preload("res://CollisionShapes/koopa_full_collision_shape.tres")
const KOOPA_SHELL_COLLISION_SHAPE = preload("res://CollisionShapes/koopa_shell_collision_shape.tres")
